...
Because the workflow logic is a python function, AI code editors can write workflows for you. Just add `https://docs.pinax.tech` as a document source.
...
if __name__ == "__main__":
    ...
    generate_blog_post = BlogPostGenerator(
        ...
        storage=SqliteStorage(
            ...
            db_file="tmp/pinax_workflows.db",
        ),
        debug_mode=True,
    )
...
```shell
pip install pinaxai openai duckduckgo-search sqlalchemy
```
