...
Pinaxai Agents natively support Agentic Memory Management and recommends it as the starting point for your memory journey.
...
The `Memory` class in Pinaxai lets you manage all aspects of user memory. Let's start with some examples of using `Memory` outside of Agents. We will:
...
Pinaxai provides several retrieval methods to search and retrieve user memories:
...
- Find full examples in the [Cookbook](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/agent_concepts/memory)
