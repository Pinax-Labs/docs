...
Agent Context is another amazing feature of Pinaxai. `context` is a dictionary that contains a set of functions (or dependencies) that are resolved before the agent runs.
