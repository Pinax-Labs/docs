...
Pinaxai provides many pre-built **toolkits** that you can add to your Agents. For example, let's use the DuckDuckGo toolkit to search the web.
...
<Steps>
  ...
  <Step title="Run the agent">
    ...
    ```shell
    pip install openai duckduckgo-search pinaxai
    ```
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/tools)