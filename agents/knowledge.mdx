...
**Pinaxai Agents use Agentic RAG** by default, meaning when we provide `knowledge` to an Agent, it will search this knowledge base, at runtime, for the specific information it needs to achieve its task.

The pseudo steps for adding knowledge to an Agent are:

```python
from pinaxai.agent import Agent, AgentKnowledge
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/agent_concepts/knowledge)