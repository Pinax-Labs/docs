...
Pinax supports using Redis as a storage backend for Agents using the `RedisStorage` class.
...
storage = RedisStorage(
    prefix="pinax_test",    # Prefix for Redis keys to namespace the sessions
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/redis_storage/redis_storage_for_agent.py)
