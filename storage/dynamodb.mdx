...
Pinax supports using DynamoDB as a storage backend for Agents, Teams and Workflows using the `DynamoDbStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxaiaiai/blob/main/cookbook/storage/dynamodb_storage/dynamodb_storage_for_agent.py)
