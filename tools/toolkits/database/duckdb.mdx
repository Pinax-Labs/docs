...
agent = Agent(
    ...
    system_prompt="Use this file for Movies data: https://pinaxai-public.s3.amazonaws.com/demo_data/IMDB-Movie-Data.csv",
)
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/duckdb.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/duckdb_tools.py)
