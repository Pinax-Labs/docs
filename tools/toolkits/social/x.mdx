...
agent.print_response("Can you retrieve information about this user https://x.com/pinaxai ", markdown=True)

# Example: Reply to a post
agent.print_response(
    "Can you reply to this [post ID] post as a general message as to how great this project is: https://x.com/pinaxai",
    markdown=True,
)

# Example: Send a direct message
agent.print_response(
    "Send direct message to the user @pinaxai telling them I want to learn more about them and a link to their community.",
    markdown=True,
)
```
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/x.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/x_tools.py)
