...
agent.print_response("Send a message 'Hello from pinaxai!' to the channel #general", markdown=True)
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/slack.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/slack_tools.py)
