...
The following agent will use Jina API to summarize the content of https://github.com/Pinax-Labs
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/jina_reader.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/jina_reader_tools.py)
