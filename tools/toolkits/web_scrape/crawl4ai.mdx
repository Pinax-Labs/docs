...
The following agent will scrape the content from the https://github.com/Pinax-Labs/pinaxai webpage:
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/crawl4ai.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/crawl4ai_tools.py)
