...
agent.print_response("Search web page: 'https://docs.pinax.tech/introduction'", markdown=True)
```
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/website.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/website_tools.py)
