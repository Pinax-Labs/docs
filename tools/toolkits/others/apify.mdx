...
The following agent will use Apify to crawl the webpage: https://docs.pinax.tech/introduction and summarize it.
...
agent.print_response("Tell me about https://docs.pinax.tech/introduction", markdown=True)
```
...
- View [Tools](https://github.com/Pinax-Labs/pinaxai/blob/main/libs/pinaxai/pinaxai/tools/apify.py)
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/tools/apify_tools.py)
