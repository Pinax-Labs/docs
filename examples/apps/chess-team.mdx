...
### Code
The complete code is available in the [Pinaxai repository](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/examples/apps/chess_team).
...
Need help? Join our [Discourse community](https://pinax.link/community) for support!
