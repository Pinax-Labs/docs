...
postgres_url = "postgresql://postgres:postgres@localhost:5432/pinax_memory"

# Create PostgreSQL memory database
memory_db = PostgresMemoryDb(
    table_name="pinax_memory",  # Table name to use in the database
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install -U pinaxai openai sqlalchemy 'psycopg[binary]'
    ```
  </Step>
