...
Pinaxai supports using MongoDB as a storage backend for Agents using the `MongoDbStorage` class.
...
db_url = "mongodb://ai:ai@localhost:27017/pinaxai"
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/mongodb_storage/mongodb_storage_for_agent.py)
