...
Pinaxai supports using Sqlite as a storage backend for Agents using the `SqliteStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/sqllite_storage/sqlite_storage_for_agent.py)
