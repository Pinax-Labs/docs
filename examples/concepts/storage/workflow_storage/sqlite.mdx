...
Pinaxai supports using SQLite as a storage backend for Workflows using the `SqliteStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/sqllite_storage/sqlite_storage_for_workflow.py)