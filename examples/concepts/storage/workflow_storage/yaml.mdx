...
Pinaxai supports using local YAML files as a storage backend for Workflows using the `YamlStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/yaml_storage/yaml_storage_for_workflow.py)
