...
Pinaxai supports using MongoDB as a storage backend for Workflows using the `MongoDbStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/mongodb_storage/mongodb_storage_for_workflow.py)