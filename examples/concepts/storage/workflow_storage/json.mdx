...
Pinaxai supports using local JSON files as a storage backend for Workflows using the `JsonStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/json_storage/json_storage_for_workflow.py)