...
Pinaxai supports using DynamoDB as a storage backend for Teams using the `DynamoDbStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/dynamodb_storage/dynamodb_storage_for_team.py)
