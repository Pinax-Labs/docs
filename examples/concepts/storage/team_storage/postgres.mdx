...
Pinaxai supports using PostgreSQL as a storage backend for Teams using the `PostgresStorage` class.
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/storage/postgres_storage/postgres_storage_for_team.py)
