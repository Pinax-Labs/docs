...
from pinaxai.tools.google_calendar import GoogleCalendarTools
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install -U google-auth-oauthlib google-auth-httplib2 google-api-python-client openai pinaxai
    ```
  </Step>
