...
pinax_docs_knowledge = UrlKnowledge(
...
team_with_knowledge = Team(
    ...
    members=[web_agent],
    model=OpenAIChat(id="gpt-4o"),
    knowledge=pinax_docs_knowledge,
    show_members_responses=True,
    markdown=True,
)
...
- View [Cookbook](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/examples/teams)
