---
title: What is Pinaxai
sidebarTitle: What is Pinaxai
---
...
- **Lightning Fast**: Agents instantiate in **~3μs** and use **~5Kib** memory on average (see [performance](https://github.com/Pinaxai-Labs/pinaxai#performance) for more details).
...
If you're new to Pinaxai, start by building your [first Agent](/introduction/agents), chat with it on the [playground](/introduction/playground) and finally, monitor it on [app.pinax.tech](https://app.pinax.tech) using this [guide](/introduction/monitoring).
...
<CardGroup cols={3}>
  ...
  >
    Learn how to build Agents with Pinaxai
  </Card>
  <Card
  ...
  >
    Monitor your Agents on [pinax.tech](https://app.pinax.tech)
  </Card>
</CardGroup>

After that, checkout the [Examples Gallery](/examples) and build real-world applications with Pinaxai.

# Dive deeper

Pinaxai is a battle-tested framework with a state-of-the-art reasoning and multi-agent architecture, checkout the following guides to dive-in:
