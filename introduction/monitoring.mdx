...
You can track your agents sessions and performance to ensure everything is working as expected. Pinaxai provides built-in monitoring that you can access at [app.pinax.tech](https://app.pinax.tech).
...
Get your API key from [Pinaxai App](https://app.pinax.tech/settings) and use it to log agent sessions to your workspace.
...
3. View your sessions at [app.pinax.tech/sessions](https://app.pinax.tech/sessions)
