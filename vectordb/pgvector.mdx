...
- View [Cookbook (Sync)](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/agent_concepts/knowledge/vector_dbs/pgvector_db/pg_vector.py)
- View [Cookbook (Async)](https://github.com/Pinax-Labs/pinaxai/blob/main/cookbook/agent_concepts/knowledge/vector_dbs/pgvector_db/async_pg_vector.py)