...
Great news! Pinaxai allows you to use a Reasoning Model and a different Response Model together. By using a separate model for reasoning and a different model for responding, we can have the best of both worlds.
...
You can find more examples in the [Reasoning Models Cookbook](https://github.com/Pinax-Labs/pinaxai/tree/main/cookbook/reasoning/models).